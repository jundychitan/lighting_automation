...
{{('NiceAdmin-pro/assets/vendor/bootstrap/css/bootstrap.min.css')}}
  <!-- Vendor JS Files -->
  <script src="{{('NiceAdmin-pro/assets/vendor/apexcharts/apexcharts.min.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/chart.js/chart.min.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/echarts/echarts.min.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/quill/quill.min.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/simple-datatables/simple-datatables.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/tinymce/tinymce.min.js')}}"></script>
  <script src="{{('NiceAdmin-pro/assets/vendor/php-email-form/validate.js')}}"></script>
